...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <img src="../../assets/dist/img/buku.jpg" width="120px" height="120px" style="display: block; margin-left: auto; margin-right: auto; margin-top: 100px;">

        <h1 class="text-center"><?= $row['nama_app']; ?></h1>
        <p class="text-center">Perpustakaan Digital <?= $row['alamat_app']; ?></p>
    </section>
    <!-- /.content -->
</div>